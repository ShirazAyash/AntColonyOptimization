"""
CODE SOURCE : https://github.com/jedrazb/python-tsp-simulated-annealing/blob/master/simulated_annealing.py
"""
...
class SimulatedAnnealing:
    def __init__(self, coords, temp, alpha, stopping_temp, stopping_iter):
        ...
        self.curr_solution = tsp_utils.randomSolution(self.dist_matrix)
    ...
    def weight(self, sol):
        ...
        return sum([self.dist_matrix[i, j] for i, j in zip(sol[:-1], sol[1:])])
    ...
    def anneal(self):
        ...
        print('Iters : ', self.iteration)
        return  self.min_weight

    def ret_times(self):
        return (self.times, self.ttime)
