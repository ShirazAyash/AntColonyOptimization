"""
CODE SOURCE: https://github.com/pjmattingly/ant-colony-optimization
"""
...
class ant_colony:
    ...
    def __init__(self, nodes, distance_callback, start=None, ant_count=50, alpha=1, beta=1.2,
    ...
    def mainloop(self):
        ...
        for j in range(self.iterations):
            ...
            self.ttime += t2 - t1
            self.stats.append(self.shortest_distance)
    ...
    def ret_t_stats(self):
        return self.ttime / self.iterations, self.times